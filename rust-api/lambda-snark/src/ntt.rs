...
pub fn ntt_forward(coeffs: &[u64], modulus: u64, omega: u64) -> Vec<u64> {
    let n = coeffs.len();
    assert!(n.is_power_of_two(), "NTT size must be power of 2, got {}", n);
...
mod tests {
    ...
    fn test_ntt_linearity() {
        ...
        for i in 0..4 {
            linear_combo[i] = ((a as u128 * f[i] as u128 + b as u128 * g[i] as u128) % Q as u128) as u64;
        }
        ...
        for i in 0..4 {
            expected[i] = ((a as u128 * ntt_f[i] as u128 + b as u128 * ntt_g[i] as u128) % Q as u128) as u64;
        }
